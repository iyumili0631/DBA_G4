...
class CreateCustomerSerializer(serializers.ModelSerializer):
    ...
    avg_purchase_interval = serializers.FloatField(required=False, allow_null=True)
    avg_purchase_value = serializers.FloatField(required=False, allow_null=True)
    lifetime_value = serializers.FloatField(required=False, allow_null=True)     
